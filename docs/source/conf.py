...
from recursiveimport import VERSION, VERSION_SHORT  # noqa: E402

# -- Project information -----------------------------------------------------

project = "recursiveimport"
...
html_title = f"recursiveimport v{VERSION}"
...
html_theme_options = {
    "footer_icons": [
        {
            "name": "GitHub",
            "url": "https://github.com/alelom/python-recursiveimport",
            "html": """
